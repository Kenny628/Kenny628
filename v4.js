...
// });
// // var tmpState=false;
// // if(this.state.data[index].activeState==false){
// //   tmpState=true
...
// }
// buttonPressed(index) {
//   var t2=this.state.data
// if(this.state.data[index].activeState==false){
//   this.setState({
//     data2: this.state.data
// }, () => {
//   this.state.data[index].activeState=true
// });

// }
// else if(this.state.data[index].activeState==true){
//   this.setState({
//     data2: this.state.data
  
// }, () => {
//   this.state.data[index].activeState=false
